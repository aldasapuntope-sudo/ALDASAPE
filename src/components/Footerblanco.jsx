...
export default function Footerblanco({ fondo = "" }) {
  ...
  return (
    <footer className="footer-area">
      <div className="footer-top" style={{background: 'white', color: '#565656', padding: '82px 0 65px'}}>
        <div className="container">
          <div className="row justify-content-between">
              ...
              <div className="footer-logo-area footer-logo-area-2">
                <div className="item-logo mb-3">
                  <img
                    ...
                    alt="logo"
                    className="img-fluid"
                    style={{background: '#565656', padding: '5px', borderRadius: '5px' }}
                  />
                </div>
                <p>
            ...
            <div className="col-xl-2 col-lg-2 col-md-6 col-sm-6">
              <div className="footer-link2 footer-link-style-2">
                <h3 className="footer-title2">Enlaces Directos</h3>
                <ul>
            ...
            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
              <div className="footer-insta">
                <h3 className="footer-title2">Lugares más buscados</h3>
                <ul className="insta-link2">
                  {lugares.length > 0 ? (
                    lugares.map((lugar) => (
                      <li key={lugar.id}>
            ...
            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
              <div className="footer-contact footer-contact-style-2">
                <h3 className="footer-title2">Contacto</h3>
                <ul className="footer-location2">
