...
export default function CaracteristicaFormclub({ Caracteristica, onClose }) {
    ...
    onSubmit: async (values) => {
      ...
      try {
        if (Caracteristica) {
          ...
          await axios.post(
            `${config.apiUrl}api/administracion/acaracteristicaclub/${Caracteristica.id}`,
            formData,
            { headers: { "Content-Type": "multipart/form-data" } }
          );
          Swal.fire("✅ Actualizado", "La característica fue actualizada correctamente", "success");
        } else {
          await axios.post(`${config.apiUrl}api/administracion/rcaracteristicaclub`, formData, {
            headers: { "Content-Type": "multipart/form-data" },
          });
  ...
  useEffect(() => {
    if (Caracteristica) {
      ...
      if (Caracteristica.icono) {
        setPreview(`${config.urlserver}iconosclub/${Caracteristica.icono}`);
      }
    }
  }, [Caracteristica]);
