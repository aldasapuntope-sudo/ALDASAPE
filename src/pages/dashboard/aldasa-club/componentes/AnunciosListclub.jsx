  ...
  const cargarDatos = async () => {
    ...
    try {
      const res = await axios.get(
        `${config.apiUrl}api/aldasaclub/listar/${isPublish}/${usuario.usuarioaldasa.id}`
      );

      console.log(`${config.apiUrl}api/aldasaclub/listar/${isPublish}/${usuario.usuarioaldasa.id}`);
...
export default AnunciosListclub;
