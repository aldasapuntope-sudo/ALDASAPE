...
const NuevoAnuncioclub = ({ anuncio = null, onClose, onRefresh }) => {
  console.log(anuncio);
  ...
  return (
    <div className="card shadow-sm border-0 p-4">
      <h4 className="mb-4 text-success fw-bold">
        {anuncio ? "✏️ Editar Propiedad" : "🏠 Publicar nueva Propiedad"}
      </h4>
      ...
      >
        ...
        <div className="col-12 mt-4 text-end">
          <button type="submit" className="btn btn-success px-4 py-2 fw-bold rounded-3">
            {anuncio ? <><FaSave /> Guardar cambios</> : <><FaBullhorn /> Publicar Propiedad</>}
          </button>
        </div>
      </form>
    </div>
...
export default NuevoAnuncioclub;
